...
class Admin extends \Cockpit\AuthController {
    ...
    public function help($collection, $ref) {
        ...
        $entry = $this->module('collections')->findOne($collection['name'], ['reference' => $ref]);
    ...
    public function documentation() {
        return $this->render('collections:views/documentation.php');
    }
}
