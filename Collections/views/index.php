...
<div riot-view>
    ...
    <div if="{ ready }">
        ...
        <div class="uk-margin uk-clearfix" if="{ App.Utils.count(collections) }">
            ...
            <div class="uk-form-icon uk-form uk-text-muted uk-width-1-2">
            ...
            <div class="uk-float-right uk-width-1-2 uk-text-right">
                ...
                <a class="uk-button uk-button-large uk-button-primary" href="@route('/collections/collection')"><i class="uk-icon-plus-circle uk-icon-justify"></i>  @lang('Collection')</a>

                <a class="uk-button uk-button-large uk-button-muted" href="@route('/collections/documentation')"><i class="uk-icon-book"></i>  @lang('Documentation')</a>
        ...
        <div class="uk-width-medium-1-1 uk-viewport-height-1-3 uk-container-center uk-text-center uk-flex uk-flex-middle uk-flex-center" if="{ !App.Utils.count(collections) }">
            ...
            <div class="uk-width-medium-1-3 uk-animation-scale">
                ...
                <h3>@lang('No Collections'). <a href="@route('/collections/collection')">@lang('Create a Collection').</a></h3>
        ...
        remove(e, collection) {
            ...
            App.ui.confirm("@lang('Are you sure')", function() {
                ...
                App.callmodule('collections:removeCollection', collection).then(function(data) {
                    ...
                    App.ui.notify("@lang('Collection removed')", "success");
