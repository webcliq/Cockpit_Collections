...
$app->on('admin.init', function() {
    ...
    $this->helper('admin')->addAssets([
       'collections:assets/field-collectionlink.tag',    
       'collections:assets/js/basket.js',
       'collections:assets/css/style.css',
       'collections:assets/js/cliqlibraries.js',
       'collections:assets/js/cliqadmin.js',
       'collections:assets/js/cliq.js'
